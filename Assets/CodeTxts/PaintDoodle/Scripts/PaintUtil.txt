...
namespace PaintDoodle
{
    ...
    {
        public const int LiquidLayer = 8;                 // 液体 billboard 专用渲染层（只被液体相机看见）
        public const int LiquidMask  = 1 << LiquidLayer;

        public const int PaintableLayer = 9;              // 可涂画表面层（地面/墙/任意物体）—— 主相机可见 + 被 raycast
        public const int PaintableMask  = 1 << PaintableLayer;
